...
namespace Projeto01.Areas.Seguranca.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Create (UsuarioViewModelo model)
        {
            if (ModelState.IsValid)
            {
                Usuario user = new Models.Usuario { UserName = model.Nome, Email = model.Email };
        ...
        [HttpPost]
        public ActionResult Edit (UsuarioViewModelo uvm)
        {
            if (ModelState.IsValid)
            {
